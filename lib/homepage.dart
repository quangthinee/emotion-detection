...
import 'package:sc_dummy/utilities/key.dart';
import 'package:sc_dummy/youtube/screens/home_screen.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void getData() async {
    ...
    http.Response response = await getEmotion(File(_image!.path));
    String emotion = '';
  ...
  _onBasicAlertPressed(context) {
    Alert(
            ...
            title: "INFO",
            desc:
                "The app can detect the following emotions: anger, contempt, disgust, fear, happiness, neutral, sadness, surprise")
        .show();
  }
